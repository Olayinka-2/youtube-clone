...
const PlayVideo = () => {
  ...
  const fetchVideoData = async () => {
    ...
    await fetch(videoDetails_url).then((res) =>
  ...
  const fetchOtherData = async () => {
    ...
    const commentsData_url = `https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet%2Creplies&maxResults=50&videoId=${videoId}&key=${API_KEY}`;
    await fetch(commentsData_url)
      .then((res) => res.json())
